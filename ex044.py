...
if opcao == 1:
  ...
  print(f'sua compra é de {valorProduto:.2f}, vai custar R${condicaoCartao:.2f} no final')
elif opcao == 4:
  parcelas = int(input('quantas parcelas?... '))
  condicaoCartaoJuros = (valorProduto / parcelas) + (valorProduto / parcelas * 20 / 100)
  if parcelas == 1:
    ...
    print(f'sua compra de {valorProduto:.2f} vai custar R${parcelas * condicaoCartaoJuros:.2f}  ao final')
else:
